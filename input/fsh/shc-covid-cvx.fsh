...
* ^compose.include.concept[=].designation[=].use.system = "http://hl7.org/fhir/name-use"
* ^compose.include.concept[=].designation[=].use.display = "usual"
...
Id: name-use
Title: "Name Use"
Description: "The use of a human name applied to vaccine designations."
